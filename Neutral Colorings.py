...
#erdos renyi graph data, numbered 1-8 where 1 is for a 0.5 degree graph and 8 is for a 4 degree graph
...
#variables to change 
filename = "Graph6.g"  #in order to get the graph
graph_data = graph6_data  #get the graph data
...
#function to plot 1 step neutrality, with neutrality values gotten from previous code
